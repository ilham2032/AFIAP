...
import type { UpdateProfilePayload, User } from '../../lib/auth'
...
const SettingsForm = ({ user, updateProfile }: SettingsFormProps) => {
...
const AccountSettings = () => {
  ...
  return (
    <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm lg:p-8">
      ...
      <SettingsForm
        key={`${user.id}-${user.email}-${user.name}-${user.surname}-${user.dateOfBirth}`}
        user={user}
